DATASET CAN BE FOUND HERE: https://www.kaggle.com/competitions/santander-customer-transaction-prediction/data
DATASET IS TOO BIG TO BE INCLUDED IN GITHUB REPO
...
To use our RandomForestClassifier model, in main.py declare declare a RandomForest object with the following hyper parameter: 
    ...
    processses = # number of processess, default is 1
	min_split = # minimum number of examples for the node to be declared terminal default is 2
	random_state = #default is 42, ensures reproducability
	verbose = # True or False, prints the trees that have finished building, and their timee in console
...
score(model,predicitions,actual_result): # prints accuracy,precision,recall,f1score and a confusion matrix
